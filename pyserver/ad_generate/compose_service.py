# compose_service.py  (DROP-IN 교체본: 기존 구조 유지 + JSON 동시 반환)
import os
import sys
import json
import base64
...
# Step2(배경 합성) Vertex/Google GenAI 환경 체크를 건너뛸지(개발 편의)
