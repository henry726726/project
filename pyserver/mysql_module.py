...
class MySQLLoader:
    ...
    def get_ad_content_sync(self, ad_content_id: int):
        ...
        try:
            ...
            with conn.cursor() as cursor:
                ...
                sql = "SELECT original_image_base64, product, ad_text, generated_image_base64, image_url FROM ad_contents WHERE id = %s"
    ...
    def update_generated_image_sync(self, ad_content_id: int, final_image_base64: str):
        """
