...
function MainPage({ userData, onLogout, isLoggedIn }) {
  ...
  */
  ...
  const menuButtonStyle = {
    ...
    border: "1px solid rgba(187,134,252,0.5)" /* ✅ 테두리: 보라색 계열에 맞게 */,
    ...
    transition: "background 0.2s ease, box-shadow 0.2s ease" /* 색상 변화 애니메이션 - 기존 값 유지 */,
    minWidth: "150px" /* 버튼의 최소 너비 지정 (너무 좁아지는 것 방지) - 기존 값 유지 */,
  ...
  return (
    ...
    >
      ...
      >
        <h2 style={{ color: '#A8E6CF' }}>원하는 메뉴를 선택해주세요!</h2> {/* ✅ h2 태그 색상 변경 (원본 유지) */}
      </main>
