...
const LoginSignup = ({ onLogin }) => {
  ...
  return (
    <>
      <Header isLoggedIn={Boolean(localStorage.getItem('jwtToken'))} onLogout={() => {
      ...
      <div style={containerStyle}>
        ...
        <div style={submitContainerStyle}>
          <div
            ...
            style={{ ...submitButtonStyle, ...(action === 'Login' ? submitButtonGrayStyle : {}) }}
            onClick={() => {
              if (action === 'Sign Up') {
                handleSubmit();
              } else {
          ...
          <div
            ...
            style={{ ...submitButtonStyle, ...(action === 'Sign Up' ? submitButtonGrayStyle : {}) }}
            onClick={() => {
              if (action === 'Login') {
                handleSubmit();
              } else {
